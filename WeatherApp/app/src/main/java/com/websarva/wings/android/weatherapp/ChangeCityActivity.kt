...
class ChangeCityActivity : AppCompatActivity() {
    companion object {
        ...
        private const val WEATHER_URL = "https://api.openweathermap.org/data/2.5/weather?lang=ja"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //SimpleAdapterを生成
        val adapter = SimpleAdapter(this@ChangeCityActivity, _list, android.R.layout.simple_list_item_1, from, to)
    ...
    private inner class ListItemClickListener: AdapterView.OnItemClickListener {
        override fun onItemClick(parent: AdapterView<*>, view: View, position: Int, id: Long) {
            ...
            q?.let {
                val urlFull = "${WEATHER_URL}&q=$q&appid=$APP_ID"
            ...
            //インテントオブジェクトを生成
            val intent = Intent(this@ChangeCityActivity, MainActivity::class.java)
